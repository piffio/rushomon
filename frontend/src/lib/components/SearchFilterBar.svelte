...
<div class="bg-white rounded-2xl border-2 border-gray-200 p-4 sm:p-6">
  ...
  >
    ...
    <div class="flex flex-wrap gap-3 lg:gap-4 items-center">
      ...
      <!-- Sort Dropdown -->
      <div class="flex items-center gap-2">
        <span class="text-sm text-gray-600 whitespace-nowrap">Sort:</span>
        <select
          value={sort}
          onchange={(e) =>
            handleSortChange(e.currentTarget.value as FilterState["sort"])}
      ...
      {#if availableTags.length > 0}
        <div class="flex items-center gap-2">
          <span class="text-sm text-gray-600 whitespace-nowrap">Tags:</span>
          <div class="relative" data-tag-dropdown>
            ...
            >
              ...
              >
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2.5"
                  d={showTagDropdown ? "M5 15l7-7 7 7" : "M19 9l-7 7-7-7"}
                />
              </svg>
            </button>
            ...
            {#if showTagDropdown}
              ...
              >
                {#if availableTags.length === 0}
                  <p class="px-3 py-2 text-sm text-gray-400">No tags yet</p>
                {:else}
      ...
      <span class="text-gray-500">
        ...
        {#if status !== "all"}
          <span class="text-gray-400"
            >({status === "active" ? "active only" : "disabled only"})</span
          >
        {/if}
        {#if selectedTags.length > 0}
          <span class="text-gray-400"
