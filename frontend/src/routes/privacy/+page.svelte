...
<svelte:head>
	<title>Privacy Policy - Rushomon</title>
	<meta
		name="description"
		content="Privacy Policy for Rushomon URL shortener. Learn how we collect, use, and protect your personal information."
	/>
</svelte:head>
			...
			<div class="prose prose-gray max-w-none space-y-8">
				...
				<section>
					...
					<p class="text-gray-700 leading-relaxed">
						Rushomon ("the Service") is committed to protecting your
					...
					<p class="text-gray-700 leading-relaxed">
						This policy applies to the hosted instance of Rushomon
						operated at this domain. If you self-host Rushomon, you
						are responsible for complying with applicable privacy
						laws.
					</p>
				</section>
				...
				<section>
					...
					<p class="text-gray-700 leading-relaxed">
						When you create an account through OAuth providers
						(GitHub or Google), we collect the following
						information:
					</p>
					<ul
						class="list-disc list-inside text-gray-700 leading-relaxed ml-4"
					>
						<li>
							<strong>Name:</strong> Your display name from the OAuth
							provider
						</li>
						<li>
						...
						<li>
							<strong>User ID:</strong> Unique identifier from the
							OAuth provider
						</li>
					</ul>
					...
					<p class="text-gray-700 leading-relaxed">
						To provide our URL shortening service, we collect and
						store:
					</p>
					<ul
						class="list-disc list-inside text-gray-700 leading-relaxed ml-4"
					>
						...
						<li>
							<strong>Short codes:</strong> Generated short codes for
							your links
						</li>
						<li>
							<strong>Analytics data:</strong> Click counts and timestamps
							for your links
						</li>
						<li>
					...
					<p class="text-gray-700 leading-relaxed">
						We automatically collect technical information to
						operate the service:
					</p>
					<ul
						class="list-disc list-inside text-gray-700 leading-relaxed ml-4"
					>
						<li>
							<strong>IP addresses:</strong> Temporarily for rate limiting
							and security
						</li>
						<li>
							<strong>Browser information:</strong> User agent and
							browser type
						</li>
						<li>
							<strong>Usage patterns:</strong> How you interact with
							our service
						</li>
					</ul>
				</section>
				...
				<section>
					...
					>
						...
						<li>
							<strong>Account Management:</strong> To authenticate
							and manage your account
						</li>
						<li>
							<strong>Analytics:</strong> To provide click statistics
							for your links
						</li>
						<li>
				...
				<section>
					...
					>
						<li>
							...
							with Cloudflare for hosting and infrastructure
						</li>
						<li>
						...
						<li>
							<strong>Safety:</strong> We may share information to
				...
				<section>
					...
					>
						...
						<li>
							<strong>Secure Authentication:</strong> OAuth providers
							handle authentication
						</li>
						<li>
							<strong>Regular Security Updates:</strong> We keep our
				...
				<section>
					...
					>
						...
						<li>
							<strong>URL Data:</strong> Retained until you delete
							the specific URL
						</li>
						<li>
							<strong>Analytics Data:</strong> Retained for the lifetime
							of the URL
						</li>
						<li>
							<strong>Technical Data:</strong> Retained for a limited
				...
				<section>
					...
					<p class="text-gray-700 leading-relaxed">
						Rushomon is hosted on Cloudflare's global
						infrastructure. Your personal information may be
						transferred to and processed in countries other than
				...
				<section>
					...
					>
						...
						<li>
							<strong>Email:</strong> Available through our GitHub
							repository
						</li>
						<li>
