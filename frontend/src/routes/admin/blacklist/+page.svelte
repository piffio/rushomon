  ...
  async function handleAddEntry() {
    ...
    try {
      ...
      if (response.success) {
        ...
        showToastMessage(response.message || "Failed to add destination");
      }
    } catch (err) {
  ...
  >
    ...
    >
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary" onclick={handleAddEntry}>Add</button>
      </div>
    </div>
  </div>
{/if}
  ...
  >
    ...
    >
      <div class="modal-header">
        ...
        <button class="modal-close" onclick={() => (showRemoveModal = false)}
          >&times;</button
        >
      </div>
      <div class="modal-body">
        ...
        <p class="warning">
          This will allow users to create links to this destination again.
        </p>
      </div>
      <div class="modal-footer">
        <button
