    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
      ...
      {:else if accepted}
        <div class="flex flex-col items-center py-4 gap-4 text-center">
          ...
          <p class="text-gray-500 text-sm">Redirecting you to the dashboard…</p>
        </div>
      {:else if !inviteInfo?.valid}
        <div class="flex flex-col items-center py-4 gap-4 text-center">
          ...
          <h1 class="text-xl font-bold text-gray-900">Invitation not valid</h1>
      ...
      {:else}
        ...
        <div class="text-center mb-6">
          ...
          <h1 class="text-xl font-bold text-gray-900">You've been invited!</h1>
          <p class="text-gray-600 mt-2">
            <span class="font-medium">{inviteInfo.invited_by}</span>
            invited you to join
            <span class="font-medium text-gray-900">{inviteInfo.org_name}</span>
          </p>
        ...
        {#if data.user}
          ...
          <div class="bg-gray-50 rounded-xl p-4 mb-5 text-sm text-gray-700">
            ...
            {#if inviteInfo.email && data.user.email.toLowerCase() !== inviteInfo.email.toLowerCase()}
              <p class="mt-1 text-amber-700 font-medium">
                ⚠️ This invite was sent to <span class="font-semibold"
        ...
        {:else}
          ...
          <p class="text-sm text-gray-600 mb-5 text-center">
            Sign in to accept this invitation. Your account email must match
