  ...
  async function handleSubmit() {
    ...
    try {
      ...
      await apiClient.post("/api/reports/links", {
        ...
        reason,
        reporter_email: currentUser?.email || reporterEmail || undefined
      });
  ...
  <div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="text-center mb-12">
      ...
      <p class="text-xl text-gray-600 max-w-2xl mx-auto">
        Help us keep Rushomon safe by reporting links that violate our terms of
        service or contain inappropriate content.
      </p>
    </div>

    <div class="bg-white rounded-lg shadow-md p-8 mb-8">
      <h2 class="text-2xl font-semibold text-gray-900 mb-6">How to Report</h2>
      ...
      <div class="space-y-6">
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-gray-600">
              ...
              https://r.sh/abc123) or copy the link ID from the URL.
            </p>
          </div>
        </div>
        ...
        <div class="flex items-start gap-4">
          ...
          <div>
            <h3 class="font-semibold text-gray-900 mb-2">Enter Link ID</h3>
            <p class="text-gray-600 mb-4">
              Enter the short code or full link ID in the field below.
            </p>
        ...
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-gray-600">
              Explain why you're reporting this link and provide any additional
              context that might help our review team.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
      ...
      <ul class="space-y-2 text-blue-800">
        ...
        <li>
          • We'll investigate the reported link and take appropriate action
        </li>
    ...
    <div class="bg-gray-50 rounded-lg p-6">
      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        <div>
          <h4 class="font-medium text-gray-900 mb-2">Do Not Report:</h4>
          <ul class="space-y-1 text-sm text-gray-600">
    ...
    <div class="text-center">
      <p class="text-gray-600 mb-4">
        ...
        <a
          ...
          class="text-orange-600 hover:text-orange-700">Abuse Policy</a
        >
        or
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="reporter-email"
            >Your Email {currentUser ? "(authenticated)" : "(optional)"}</label
          >
