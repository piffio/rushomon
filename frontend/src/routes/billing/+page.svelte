	...
	<main class="flex-1 container mx-auto px-4 py-12 max-w-3xl">
		<div class="mb-8">
			...
			<p class="text-gray-500">
				Manage your plan, payment details, and the organizations covered
				by this billing account.
			</p>
		</div>
						...
						{#if billingStatus.subscription_status === "canceled"}
							...
							>
								<p class="text-sm text-amber-800">
									Your subscription has been canceled. Your
									account has been moved to the Free tier. You
									can resubscribe at any time from the <a
										href="/pricing"
				...
				>
					...
					<div class="space-y-2">
						...
						>
							...
							<p class="text-xs text-gray-500 mt-0.5">
								Your plan stays active until end of billing
								period
							</p>
						</button>
					</div>
