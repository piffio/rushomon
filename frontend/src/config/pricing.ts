...
export const createPricingTiers = (
  ...
  },
  {
    ...
    title: "Pro",
    description:
      "For creators who need custom codes, extended analytics, and advanced redirect controls",
    ...
    buttonText: () => {
      ...
      if (isUpgrade("pro", billingStatus)) {
        return isOnFreePlan(billingStatus)
          ? "Upgrade to Pro"
          : "Upgrade to Pro";
      }
      return "Get Started";
  ...
  },
  {
    ...
    buttonText: () => {
      ...
      if (!currentUser) return "Get Started";
      if (isCurrentPlan("business", billingStatus))
    ...
    originalPrice: () =>
      getDisplayPriceWithFallback("business", billingInterval)
  }
];
