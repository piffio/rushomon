...
use crate::models::{
    PaginatedResponse, PaginationMeta, Tier,
...
pub(crate) async fn resolved_forward_for_link(db: &D1Database, link: &Link) -> bool {
...
pub(crate) async fn sync_link_mapping_from_link(
    db: &D1Database,
...
// Blacklist handlers moved to api/admin/blacklist.rs

// handle_admin_suspend_user, handle_admin_unsuspend_user, handle_admin_delete_user,
// handle_admin_update_user_role moved to api/admin/users.rs
